...
class BaselineProf(pl.LightningModule):
    ...
    def forward(self, x1, x2):
        result = self.lin((x1-x2)**2).sum(dim=-1, keepdim=True).abs().sqrt() #need abs because negatice
    ...
    def validation_step(self, batch, batch_idx):
        ...
        weight=(1/distance)#root included
...
if __name__ == "__main__":
    ...
    #     "lightning_logs/trash/lightning_logs/version_2/checkpoints/epoch=1999-step=4000.ckpt",
